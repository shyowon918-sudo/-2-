...
with col2_2:
    ...
    st.write("✅ **인사이트:** 전국 데이터를 바탕으로 습도와 산불 피해 면적 간의 관계를 보여줍니다. **빨간선의 기울기가 급할수록** 건조한 날씨가 산불 대형화에 결정적인 영향을 미쳤음을 정량적으로 증명합니다.")
...
with col3_2:
    ...
    st.write("✅ **인사이트:** 2024년 통계상 **입산자 실화 및 소각 행위**가 가장 큰 비중을 차지하고 있어, 대국민 예방 홍보가 가장 시급한 분야임을 보여줍니다.")
